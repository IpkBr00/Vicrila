...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
 <h2>FUNCIONALIDADES DE LA APLICACION</h2>
        ...
        <div id='menuComercial'>
            <ol>
                <li>
                    <h3><a href="CreacionDossier.html" accesskey="1">Nuevo Dossier en Blanco</a></h3>
                    <p>
                        Selecciona un tipo de dossier y crea el dossier desde cero.
                    </p>
                </li>
                <li>
                    <h3><a href="CopiaDossieres.html" accesskey="2">Nuevo Dossier a partir de uno existente</a></h3>
                    <p>
                ...
                <li>
                    <h3><a href="DossieresEnCurso.html" accesskey="3">Cotizaciones en curso</a></h3>
                    <p>
                        Ver los dossieres en curso y el estado de cada uno. Permite entra a editar los datos.
                    </p>
                </li>
                <li>
                    <h3><a href="Dossieres.html" accesskey="4">Cotizaciones Completadas</a></h3>
                    <p>
        ...
        <div id='menuGeneral'>
            <ol>
                <li>
                    <h3><a href="DossieresEnCurso.html" accesskey="1">Cotizaciones en curso</a></h3>
                    <p>
                        Ver los dossieres en curso y el estado de cada uno. Permite entra a editar los datos.
                    </p>
                </li>
                <li>
                    <h3><a href="Dossieres.html" accesskey="2">Cotizaciones Completadas</a></h3>
                    <p>
                        Acceso a dossieres mediante una busqueda. Permite acceder a los datos y docuemntacion del dossier.
                    </p>
                </li>
