         ...
         var str = {
            ...
            var Utils = {
                HtmlHelpers : {
                     ...
                     toTableNormal : function(obj, options){
                        var comodinClave = "$clave$";
                        var comodinValor = "$valor$";
                        var tmplFilaTH = $("<tr>");
                        var tmplFilaTD = $("<tr>");
                        ...
                        for(var clave in obj)
                        {
                            ...
                            if(typeof obj[clave] !== "object")
                            {
                                tmplFilaTH.append("<th>"+ clave +"</th>");
                                tmplFilaTD.append("<td>"+ obj[clave] +"</td>");
                            }
                        }

                        return "<div class='toTable " + ((options.nivel)? "nivel" + options.nivel : "")  + "'><table cellspacing='0' cellpadding='0'>" + strTitulo + "<thead>" + tmplFilaTH.html()  +"</thead><tbody>" + tmplFilaTD.html() + "</tbody></table></div>";
                    }
                }
            };
	...
	<body>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                ...
                var objInspector = new ObjectInspector($container, usuario, { titulo : 'Modelo Usuario' , clase: 'colSunFlower' });
                objInspector.render();
                $container.append( saltoLinea );
                $container.append( Utils.HtmlHelpers.toTableNormal(usuario, { titulo : 'Modelo Usuario 2' , clase: 'colPeterRiver' }));
                $container.append( saltoLinea );
                $container.append( Utils.HtmlHelpers.toTableNormal(str.Solucion[0], { titulo : 'Modelo Usuario 2' , clase: 'colPeterRiver' }));
