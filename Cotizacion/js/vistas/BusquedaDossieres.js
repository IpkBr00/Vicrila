...
BusquedaDossieresPage.prototype.crearToolbarFiltros = function(){
    ...
    this.areaFiltros.agregarBoton({
        nombre : "Dossieres",
        descripcion : "Establece la busqueda para dossieres",
        clases : "",
        icono : "icon-lock",
        texto : "Dossieres"
    });
    this.areaFiltros.agregarBoton({
        nombre : "Soluciones",
        descripcion : "Establece la busqueda para soluciones",
        clases : "",
        icono : "icon-book",
        texto : "Soluciones"
    });
    this.areaFiltros.agregarBoton({
        nombre : "Formas",
        descripcion : "Establece la busqueda para formas",
        clases : "",
        icono : "icon-glass",
        texto : "Formas"
    });
    this.areaFiltros.agregarBoton({
        nombre : "Embalajes",
        descripcion : "Establece la busqueda para embalajes",
        clases : "",
        icono : "icon-inbox",
        texto : "Embalajes"
    });
