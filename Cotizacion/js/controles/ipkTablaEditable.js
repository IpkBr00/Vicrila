        ...
        if(this.accesos[grupo])
        {
            ...
            if( this.accesos[grupo][3] )
            {
                ...
                this.toolbar.onBorrar = function(){
                    ...
                    if(idRegistro){
                        ...
                        if(confirmacion)
                        {
                            self.onDeleteClick(idRegistro);
                            self.genericoDS.Delete(idRegistro);
            ...
            if( this.accesos[grupo][4] )
            {
                ...
                this.toolbar.onCopiar = function(){
                    ...
                    if(idRegistro){
                        //self.onDeleteClick(idRegistro);
                        self.genericoDS.Copiar(idRegistro, {});
                        //self.tabla.tabla.borrarFilaSeleccionada();
                    }
                };
            }
...
IpkTablaEditable.prototype.crearFicha = function(){
    ...
    this.ficha.onRecordInserted = function(respuesta){
        ...
        self.tabla.tabla.agregarRegistro(respuesta.datos);
...
IpkTablaEditable.prototype.crearGenericoDS = function(){
    var self = this;
...
/**
 * Se lanza cuando se ha pulsado el botón de borrar
 *
 * @event   onDeleteClick
 * @memberOf IpkTablaEditable
 *
 */
IpkTablaEditable.prototype.onDeleteClick = function(respuesta){};

IpkTablaEditable.prototype.habilitarToolbar = function(habilitar){
