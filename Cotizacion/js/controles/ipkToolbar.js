...
/**
 * Establece si la barra de tareas está habilitada o no
 *
 * @function
 * @public
 * @name     habilitada
 * @memberOf IpkToolbar
 *
 * @param   {Boolean}   habilitada     True para mostrarlo y false para ocultarlo
 */
IpkToolbar.prototype.habilitada = function(habilitada){
    if(habilitada)
    {
        this.propiedades.control.show();
    }
    else
    {
        this.propiedades.control.hide();
    }
