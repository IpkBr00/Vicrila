...
frmProductoListado.prototype.Init = function(){ 	this.producto.Listado(); };
frmProductoListado.prototype.VincularEventos = function(){
	...
	$('#listado').delegate('a.editar','click', function(){
		...
		formulario.producto.Buscar(celdaId.text());
	});
	...
	$('#btnGuardar').click(function(){
		...
		if($('#id').val() == '')
		{	
			formulario.productos.Insertar(datos);
		}
		else
		{
			formulario.productos.Actualizar(datos);	
		}
	});
	$('#alta').click(function(){ formulario.AbrirFormulario();	});
	$('#formulario').on('hidden', function(){ 	formulario.LimpiarFormulario();	});
};
...
frmProductoListado.prototype.AbrirFormulario = function(){ $('#formulario').modal(); };
frmProductoListado.prototype.CerrarFormulario = function(){ $('#formulario').modal('hide'); };
