var UI = {
	...
	urlJson : "js/script/configuraciones/formularios/frmArticuloTerminado.json",
	urlDefaults : "js/script/configuraciones/formularios/frmArticuloTerminado.defaults.json",
	...
	CargarValoresPorDefecto : function(){
		$.ajax({
			url: this.urlDefaults,	
		  	...
		  	error: function(jqXHR, textStatus, errorThrown){ alert( 'Error CargarValoresPorDefecto: \n' +  errorThrown );},
		  	complete: function (data){}
		});
	}, // METODOS VISTAS
