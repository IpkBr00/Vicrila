...
FichasPage.prototype.actualizarCampoFicha = function(){
    ...
    if(actualizacion.Tipo == 'Reference' || actualizacion.Tipo == 'Collection' || actualizacion.Tipo == 'ComboNavision')
    {
    ...
    if(actualizacion.Tipo == 'ComboNavision')
    {
        actualizacion.IdReferencia = parseInt($('#fuenteNavision').val());
    }
