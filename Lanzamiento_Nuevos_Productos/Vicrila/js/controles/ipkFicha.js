...
IpkFicha.prototype.aplicarSeguridad = function(){
    var self = this;
    //var campoNoDisponibles = _.filter(this.estructura , function(elemento){ return elemento.Grupo == '' || elemento.Grupo == app.seguridad.grupoActual});
    var campoNoDisponibles = _.filter(this.estructura , function(elemento){ return elemento.Grupo == '' || elemento.Grupo == app.seguridad.grupoActual});
    app.log.debug('SEGURIDAD' , campoNoDisponibles);
